            ...
            <div class="container-fluid">
                ...
                <div class="col-6 col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 col-xxl-2 p-3 " id="MuestraBTN">
                    ...
                    <form id="update-form" method="post" enctype="multipart/form-data">
                        <div class="modal fade" id="ActualizarBitacora" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Fecha</label>
                                            <input type="date" class="form-control " placeholder="" aria-describedby="basic-addon1" id="fecha2" name="fecha2" />
                                        </div>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Hora</label>
                                            <input type="time" class="form-control " placeholder="" aria-describedby="basic-addon1" id="hora2" name="hora2" />
                                        </div>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Ubicacion</label>
                                            <input class="form-control " placeholder="" aria-describedby="basic-addon1" id="ubicacion2" name="ubicacion2" type="text" />
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Cliente</label>
