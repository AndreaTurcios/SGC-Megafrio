    ...
    <div class="row">
        <nav class="navbar navbar-light bg-light">
            <div id="header" class="container-fluid">
                ...
                <button id="buttonIng" type="button" class="btn btn-light" data-bs-toggle="modal"
                    data-bs-target="#bitacoraModal" data-bs-whatever="@mdo"><i class="fas fa-plus"></i>Agregar</button>
            </div>
            <div class="modal fade" id="bitacoraModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="fecha" class="form-control" min="2000-01-01"
                                        max="2023-12-31" step="2" />
                                </div>
                                <div class="mb-3">
                                    <label for="message-text" class="col-form-label">Hora:</label>

                                    <input type="time" name="hora" class="form-control" min="18:00" max="21:00"
                                        step="3600" />
                                </div>
                                <div class="mb-3">
    ...
    <div class="col-12 p-text-center">
                ...
                <tbody>
                    ...
                    <tr class="table-light">
                        ...
                        <td><button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#editModal" data-bs-whatever="@mdo"><i class="fas fa-edit"></i></button>
                        </td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="mb-3">
                                                <label for="message-text" class="col-form-label">Selecciona un
                                                    cliente:</label>
                                                <select class="form-control" id="cli-select">
                                                    <option disabled selected>Seleccionar un cliente</option>
                                                    <option value="1">Zachery C. Horton</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="time" name="hora" class="form-control" min="18:00"
                                                    max="21:00" step="3600" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="recipient-name" class="col-form-label">Acción
                                                    realizada:</label>
                                                <input type="text" class="form-control" id="recipient-name">
                                            </div>
                                        </form>
        ...
        <tr class="table-light">
            ...
            <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal"
                    data-bs-whatever="@mdo"><i class="fas fa-edit"></i></button></td>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="fecha" class="form-control" min="2000-01-01" max="2023-12-31"
                                    step="2" />
                            </div>
                            <div class="mb-3">
                                <label for="message-text" class="col-form-label">Hora:</label>
...
<tr class="table-light">
    ...
    <td>04:05:00</td>
    <td>Compra</td>
    <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-whatever="@mdo"><i
