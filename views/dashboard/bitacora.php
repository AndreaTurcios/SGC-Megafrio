            ...
            <div class="container-fluid">
                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 p-3">
                    <form class="d-flex" method="post" id="search-form">
                        <input class="form-control me-2" id="search" name="search" type="date" placeholder="Buscar"
                            aria-label="Search">
                ...
                <div class="col-6 col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 col-xxl-2 p-3 " id="MuestraBTN">
                    ...
                    <form id="save-form" method="post" enctype="multipart/form-data">
                        <div class="modal fade" id="AgregarBitacora" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control " placeholder=""
                                                aria-describedby="basic-addon1" id="hora" name="hora" />
                                        </div>
                    ...
                    <form id="update-form" method="post" enctype="multipart/form-data">
                        <div class="modal fade" id="ActualizarBitacora" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " placeholder="" aria-describedby="basic-addon1"
                                                id="ubicacion2" name="ubicacion2" type="text" />
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Cliente</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn waves-effect blue tooltipped"
                                            data-tooltip="Guardar">Guardar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
