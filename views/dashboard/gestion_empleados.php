                  ...
                  <div class="modal-body">
                    <div class="container">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="nombre_emp"name="nombre_emp"placeholder="Nombre empleado" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" required minlength="3" maxlength="50"/>
                        </div>
                        <div class="form-group">
                        <label for="apellido_emp">Apellido empleado</label>
                        <input class="form-control" id="apellido_emp" type="text" name="apellido_emp" placeholder="Apellido empleado" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" required minlength="3" maxlength="50"/>
                        </div>
                        <div class="form-group">
