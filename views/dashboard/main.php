...
<main>
        ...
        <div class="row">   
                        ...
                        <div class="text-center col-12 col-xs-12 col-sm-12 col-lg-6 col-xl-6 p-4 col-xxl-6">
                            <!-- Se muestra una gráfica de donas con la cantidad de clientes por estado pago -->
                            <canvas id="chartClientePago"></canvas>
                        </div>
                        <div class="text-center col-12 col-xs-12 col-sm-12 col-lg-6 col-xl-6 p-4 col-xxl-6">
                            <!-- Se muestra una gráfica de barras con la cantidad de equipos por capacidad -->
                            <canvas id="chartEquipoCapacidad"></canvas>
                        </div>
